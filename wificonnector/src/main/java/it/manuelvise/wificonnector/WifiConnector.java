...
import it.manuelvise.wificonnector.interfaces.RemoveWifiListener;
import it.manuelvise.wificonnector.interfaces.ShowWifiListener;
import it.manuelvise.wificonnector.interfaces.WifiStateListener;
...
public class WifiConnector extends ConnectivityManager.NetworkCallback {
    ...
    public void setWifiConfiguration(String SSID, String BSSID, String securityType, String password) {
        ...
        this.wifiConfiguration.SSID = ssidFormat(SSID);
        this.wifiConfiguration.BSSID = ssidFormat(BSSID);
        if (securityType.equals(SECURITY_NONE)) {
            //wifiConfiguration = getExistingNetworkId(SSID);
            /*WifiConfiguration savedConf = getExistingNetworkId(SSID);
            if(savedConf==null){
                *//*wifiConfiguration.allowedAuthAlgorithms.set(WifiConfiguration.AuthAlgorithm.SHARED);
                wifiConfiguration.allowedGroupCiphers.set(15);
                wifiConfiguration.allowedKeyManagement.set(WifiConfiguration.KeyMgmt.WPA_PSK);
                wifiConfiguration.allowedPairwiseCiphers.set(6);
                wifiConfiguration.allowedProtocols.set(3); // For WPA*//*
    ...
    private WifiConfiguration getExistingNetworkId(String SSID) {
